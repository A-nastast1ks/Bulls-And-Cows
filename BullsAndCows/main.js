const start = () => {
    alert("Компьютер задумывает четыре различные числа из 0,1,2,...9. Игрок выбирает количество цифр в загаданном числе и делает ходы, чтобы узнать эти цифры и их порядок. 0 может стоять на первом месте. В ответ компьютер показывает число отгаданных цифр, стоящих на своих местах (число быков) и число отгаданных цифр, стоящих не на своих местах (число коров)");
